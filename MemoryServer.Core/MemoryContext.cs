...
namespace MemoryServer.Core.Database
{
    public class MemoryContext : DbContext
    {
        ...
        public DbSet<UserListSubscription> UserListSubscriptions { get; set; }
        public DbSet<ListUpdateTracker> ListUpdateTrackers { get; set; }
        public DbSet<Language> Languages { get; set; }
        public DbSet<BurnedAssignment> BurnedAssignments { get; set; }
        public DbSet<Post> Posts { get; set; }

        public MemoryContext([NotNull] DbContextOptions options) : base(options) { }
