...
export class ReviewBox extends React.Component {
    ...
    submitReview(event) {
        ...
        Util.postJson(`/api/${this.state.type}/submit-review`, this.state.formModel, (json) => {
            if (json.succeeded)
                this.fetchNextReview();
            else {
    ...
    loading() {
        if (this.state.formModel)
            return null;
        return (<ReactLoading type="spinningBubbles" color="#ccc" delay={100}/>);
    }
    handleInput(e) {
    ...
    render() {
        return (<div id="review-box" className="modal fade">
...
//# sourceMappingURL=ReviewBox.jsx.map