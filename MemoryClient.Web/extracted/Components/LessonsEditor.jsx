...
import { LessonsEditorModel } from "../Models";
class LessonEditorState {
    constructor() {
        this.formModel = new LessonsEditorModel();
        this.languagesFrom = [];
        this.languagesTo = [];
...
class LessonsEditor extends React.Component {
    constructor() {
        super();
        this.loadingComponent = <div className="d-flex flex-row justify-content-center"><ReactLoading type="spinningBubbles" color="#ccc" delay={100}/></div>;
    ...
    formatLangOptions(languages) {
        return languages.map((language) => {
            return ({ value: language.id, label: I18n.format(this.props.intl, language.englishName, language.ietfTag) });
        });
    }
    ...
    submit(event) {
        ...
        Util.postJson("/api/lessons/put", this.state.formModel, data => {
            const result = data;
            if (result.succeeded) {
    ...
    form() {
        ...
        return (<form id="lessons-editor-form" action="#">
